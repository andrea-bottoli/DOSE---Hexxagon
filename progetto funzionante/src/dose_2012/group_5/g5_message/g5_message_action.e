note
	description: "Summary description for {G5_MESSAGE_ACTION}, which manages all the actions related to play, discard, select and buy cards."
	author: "Luca Falsina"
	date: "14.11.2012"
	revision: "1.3"
	...
	make(a_source: STRING; some_targets: ARRAY [STRING]; an_action: STRING; some_cards: ARRAY [STRING];
		...
		require
			...
			accepted_action_for_action_message:
				...
				an_action.is_equal ("answer_of_keeping")
