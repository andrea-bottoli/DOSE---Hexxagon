...
feature --Operations
	...
	test_send_message_broadcast_1
		note
			testing: "covers/{G1_NET_SERVER}.send_message_broadcast"
		local
			server: G1_NET_SERVER
			id_match: STRING
			msg: G1_MESSAGE
		do
			create server.make
	...
	test_send_message_to_1
		note
			testing: "covers/{G1_NET_SERVER}.send_message_to"
		local
			server: G1_NET_SERVER
			player: G1_PLAYER
			message: G1_MESSAGE
...
feature -- Server settings
	...
	test_set_port_1
		...
		note
			testing: "covers/{G1_NET_SERVER}.set_port"
		local
			server: G1_NET_SERVER
			test_result: BOOLEAN
		do
	...
	test_get_port
		...
		note
			testing: "covers/{G1_NET_SERVER}.get_port"
		local
			server: G1_NET_SERVER
			test_result: BOOLEAN
		do
	...
	test_get_ip
			-- Testing get the ip
		note
			testing: "covers/{G1_NET_SERVER}.get_ip"
		local
			server: G1_NET_SERVER
			test_result: BOOLEAN
		do
	...
	test_start_server_1
		...
		note
			testing: "covers/{G1_NET_SERVER}.start_server"
		local
			server: G1_NET_SERVER
			test_result: BOOLEAN
		do
	...
	test_stop_server_0
		...
		note
			testing: "covers/{G1_NET_SERVER}.stop_server"
			testing: "user/G1"
		local
			net_server_t: G1_NET_SERVER
		do
	...
	test_set_time_out_0
		note
			testing: "covers/{G1_NET_SERVER}.set_time_out"
			testing: "user/G1"
		local
			net_server_t: G1_NET_SERVER
		do
