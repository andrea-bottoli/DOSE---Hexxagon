...
class
	TEST_SET_G5_IGUI_TO_NET_JOINT_PLAYER_WAITING_ROOM
...
feature -- Test positive
	...
	joint_player_waiting_room0
		-- joint_player_waiting_room()
		note
			testing: "G5_IGUI_TO_NET/.joint_player_waiting_room"
		do
			class_test.joint_player_waiting_room()
			assert ("joint_player_waiting_room was successfully performed", TRUE)
		end
