...
class
	...
	inherit
		ZB_LOGIC
			redefine
				isActivePlayer, rotate, placeMapCard, rollDice, useHT, useBT, movePeon, endMovement, moveZombie, discardEventCard, endTurn, placeZombie, useEventCard, playerState
				end
