...
feature -- Test routines
	...
	do
		...
		game.set_tile_to_terrain (1 , 1 , tile)
	...
	do
		...
		game.set_tile_to_terrain (2 , 1 , tile)
	...
	do
		...
		game.set_tile_to_terrain (2 , 2 , tile)
	...
	do
		...
		game.set_tile_to_terrain (1 , 1 , tile)
		assert ("tile not inserted properly", game.is_terrain_position_empty (1 , 1))
	end
	...
	do
		...
		assert ("access of status in (x,y) coordinates of terrain incorrect" , game.get_terrain_potition_status (1 , 1) = tile_status)
	end
	...
	do
		...
		game.set_tile_status (tile, tile_status)
		game.set_tile_to_terrain (15 , 20 , tile)

		assert ("access of status in (x,y) coordinates of terrain incorrect" , game.get_terrain_potition_status (15 , 20) = tile_status)
	end
	...
	do
		...
		game.set_tile_status (tile, tile_status)
		game.set_tile_to_terrain (10 , 100 , tile)

		assert ("access of status in (x,y) coordinates of terrain incorrect" , game.get_terrain_potition_status (10 , 100) = tile_status)
	end
