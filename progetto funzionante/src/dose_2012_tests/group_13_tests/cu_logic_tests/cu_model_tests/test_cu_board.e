...
feature -- Test routines
	...
	test_board
			-- Tests the board used to represents a list of squares
		note
			testing: "covers/{CU_BOARD}.board"
			testing: "user/CU"
		do
			create board.make
			assert ("Represents a list of squares not empty:", board.board.count > 0)
		end
	...
	test_find_room_0
		...
		do
			...
			assert ("The room is finded:", room.room_id = id_room)
		end
