...
feature -- Test routines
	...
	test_move_to_position
		...
		note
			...
			testing: "user/CU"
		local
			a_position: CU_SQUARE
			current_position: CU_SQUARE
			--connection: SOCKET
		do
			--connection.make_socket
			--create player.make ("Player1", 1, connection)
			create player.make ("Player1", 1)
			current_position := player.position
			player.move_to_position (a_position)
	...
	test_add_available_moves
		...
		do
			...
			player.add_available_moves (moves)
