...
feature -- Test routines
	...
	test_IG_GAMEBOARD_create_gameboard_2players
		...
		do
			...
			assert("Number of lines of the gameboard is:",l_gameboard.gameboard.width=13)
			assert("Numebr of columns of the gameboard is:",l_gameboard.gameboard.height=13)
		end
	...
	test_IG_GAMEBOARD_create_gameboard_3players
		...
		do
			...
			assert("Number of lines of the gameboard is:",l_gameboard.gameboard.width=14)
			assert("Numebr of columns of the gameboard is:",l_gameboard.gameboard.height=14)
		end
	...
	test_IG_GAMEBOARD_set_tile_on_board
		...
		do
			...
			l_gameboard.set_tile_on_board (l_move)
			assert ("Tile is placed in the gameboard", l_tile.status_tile.is_equal ("a"))
		end
