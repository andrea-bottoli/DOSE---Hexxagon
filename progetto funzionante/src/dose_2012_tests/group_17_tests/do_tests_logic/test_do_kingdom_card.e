...
--Tests the routine get_plus_cards
	test_get_plus_cards
		...
		do
			create kingdom_card.make("Village", "Kingdom card", 4, 3, 2, 1)
...
--Tests the routine get_actions
	test_get_actions
		...
		do
			create kingdom_card.make ("Chapel", "Kingdom card", 4, 3, 2, 1)
...
--Tests the routine get_buys
	test_get_buys
		...
		do
			create kingdom_card.make ("Laboratory", "Kingdom card", 4, 3, 2, 1)
...
--Tests the routine do_action
	test_do_action
		...
		do
			create kingdom_card.make ("Smithy", "Kingdom card", 4, 3, 2, 1)
