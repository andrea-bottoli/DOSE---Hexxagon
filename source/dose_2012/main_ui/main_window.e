	...
	Game_entries: attached LINKED_LIST [TUPLE [game, description: attached STRING; launcher: attached TYPE [LAUNCHER]]]
		...
		once
			create Result.make
				...
				-- Dummy entries:
		    Result.extend (["Game of group 1", "dummy_description.rtf", {DUMMY_LAUNCHER}])
			...
			Result.extend (["Bang!", "Bang!_Description.rtf", {DUMMY_LAUNCHER}])
			Result.extend (["Dominion", "group_5.rtf", {DUMMY_LAUNCHER}])
			...
			Result.extend (["Carcassonne", "group_10.rtf", {DUMMY_LAUNCHER}])
			...
			Result.extend (["Game of group 14", "dummy_description.rtf", {DUMMY_LAUNCHER}])
			Result.extend (["Blokus", "group_15.rtf", {DUMMY_LAUNCHER}])
			Result.extend (["Ingenious", "ing_description.rtf", {ING_LAUNCHER}])
			Result.extend (["Game of group 17", "dummy_description.rtf", {DUMMY_LAUNCHER}])
			Result.extend (["Hexxagon (Group 18)", "hexxagon_group18.rtf", {HX_LAUNCHER}])
			...
			Result.extend (["Game of group 21", "dummy_description.rtf", {DUMMY_LAUNCHER}])
				-- Real entries
