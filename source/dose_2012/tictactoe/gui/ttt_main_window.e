...
feature {NONE}	-- Initialization
	...
	make(a_main_ui_window: EV_TITLED_WINDOW)
			-- Creation procedure
		do
...
feature {NONE}	-- Attributes
	...
	main_ui: EV_TITLED_WINDOW
		-- the main ui, i.e. the game selector
		-- we need this reference to restore the game selector once the user quits tictactoe
	...
	con_game_text: EV_FIXED
		...
		-- framed containers for the left-hand menu
