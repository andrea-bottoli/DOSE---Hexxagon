...
extern EIF_TYPED_VALUE F297_5826(EIF_REFERENCE);
...
EIF_TYPED_VALUE F297_5826 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 296, Current, 0, 0, 5591);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(296, Current, 5591);
	RTIV(Current, RTAL);
	RTHOOK(1);
