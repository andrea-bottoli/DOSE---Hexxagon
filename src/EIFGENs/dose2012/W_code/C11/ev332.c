...
extern EIF_TYPED_VALUE F332_6536(EIF_REFERENCE);
extern EIF_TYPED_VALUE F332_6537(EIF_REFERENCE);
extern EIF_TYPED_VALUE F332_6538(EIF_REFERENCE);
...
EIF_TYPED_VALUE F332_6536 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 331, Current, 0, 0, 6261);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(331, Current, 6261);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000216, 0,0); /* Result */
	
	tr1 = RTLN(534);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(534, 142, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
...
EIF_TYPED_VALUE F332_6537 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 331, Current, 0, 0, 6262);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(331, Current, 6262);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F332_6538 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 331, Current, 0, 0, 6263);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(331, Current, 6263);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000216, 0,0); /* Result */
