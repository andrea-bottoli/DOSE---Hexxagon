...
static EIF_TYPE_INDEX gen_type0_333 [] = {0,1221,332,0xFFFF};
static EIF_TYPE_INDEX gen_type1_333 [] = {0,0,0xFFFF};
static EIF_TYPE_INDEX gen_type2_333 [] = {0,0,0xFFFF};
static EIF_TYPE_INDEX gen_type3_333 [] = {0,0,0xFFFF};


static struct desc_info desc_333[] = {
	{(BODY_INDEX) -1, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 787, NULL},
	{1, (BODY_INDEX)-1, 1221, gen_type0_333},
