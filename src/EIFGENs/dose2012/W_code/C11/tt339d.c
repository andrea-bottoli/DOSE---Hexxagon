...
static EIF_TYPE_INDEX gen_type0_339 [] = {0,1221,338,0xFFFF};
static EIF_TYPE_INDEX gen_type1_339 [] = {0,0,0xFFFF};
static EIF_TYPE_INDEX gen_type2_339 [] = {0,0,0xFFFF};
static EIF_TYPE_INDEX gen_type3_339 [] = {0,0,0xFFFF};


static struct desc_info desc_339[] = {
	{(BODY_INDEX) 6292, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 787, NULL},
	{1, (BODY_INDEX)-1, 1221, gen_type0_339},
