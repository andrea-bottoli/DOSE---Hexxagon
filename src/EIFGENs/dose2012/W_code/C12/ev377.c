...
extern EIF_TYPED_VALUE F377_7129(EIF_REFERENCE);
extern EIF_TYPED_VALUE F377_7130(EIF_REFERENCE);
...
EIF_TYPED_VALUE F377_7129 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 376, Current, 0, 0, 6815);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(376, Current, 6815);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F377_7130 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 376, Current, 0, 0, 6814);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(376, Current, 6814);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800021A, 0,0); /* Result */
