...
static EIF_TYPE_INDEX gen_type0_365 [] = {0,1221,364,0xFFFF};
static EIF_TYPE_INDEX gen_type1_365 [] = {0,0,0xFFFF};
static EIF_TYPE_INDEX gen_type2_365 [] = {0,0,0xFFFF};
static EIF_TYPE_INDEX gen_type3_365 [] = {0,0,0xFFFF};


static struct desc_info desc_365[] = {
	{(BODY_INDEX) 6682, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 787, NULL},
	{1, (BODY_INDEX)-1, 1221, gen_type0_365},
