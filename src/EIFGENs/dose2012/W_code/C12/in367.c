...
extern EIF_TYPED_VALUE F367_7002(EIF_REFERENCE);
extern EIF_TYPED_VALUE F367_7003(EIF_REFERENCE);
extern EIF_TYPED_VALUE F367_7004(EIF_REFERENCE);
extern void F367_7005(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F367_7002 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 366, Current, 1, 0, 6686);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(366, Current, 6686);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(366, 35, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F367_7003)
EIF_TYPED_VALUE F367_7003 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 366, Current, 0, 0, 6687);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(366, Current, 6687);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F367_7004)
EIF_TYPED_VALUE F367_7004 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 366, Current, 0, 0, 6688);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(366, Current, 6688);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000173, 0,0); /* Result */
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {366,1374,757,0xFFFF};
	...
	*((EIF_NATURAL_8 *)tr4+3) = (EIF_NATURAL_8) tu1_1;
	tr3 = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE))  RTWF(1374, 42, Dtype(tr4)))(tr4).it_r;
	ur2 = RTCCL(tr3);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(373, 40, Dtype(tr1)))(tr1, ur1x, ur2x);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
...
void F367_7005 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 366, Current, 0, 1, 6689);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(366, Current, 6689);
...
{
	GTCX
	RTOTS (7003,F367_7003)
	RTOTS (7004,F367_7004)
}
