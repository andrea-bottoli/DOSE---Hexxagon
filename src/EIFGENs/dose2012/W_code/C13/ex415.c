...
extern EIF_TYPED_VALUE F415_7710(EIF_REFERENCE);
...
RTOID (F415_7710)
EIF_TYPED_VALUE F415_7710 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 414, Current, 0, 0, 7386);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(414, Current, 7386);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
