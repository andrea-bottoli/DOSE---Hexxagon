...
extern EIF_TYPED_VALUE F460_7931(EIF_REFERENCE);
...
RTOID (F460_7931)
EIF_TYPED_VALUE F460_7931 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 459, Current, 0, 0, 7607);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(459, Current, 7607);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
