...
extern void F515_9482(EIF_REFERENCE);
extern EIF_TYPED_VALUE F515_9483(EIF_REFERENCE);
...
void F515_9482 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 514, Current, 2, 0, 10809);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(514, Current, 10809);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(3);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(514, 2, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
RTOID (F515_9483)
EIF_TYPED_VALUE F515_9483 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 514, Current, 0, 0, 10810);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(514, Current, 10810);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	tr1 = RTLN(519);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(519, 147, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
