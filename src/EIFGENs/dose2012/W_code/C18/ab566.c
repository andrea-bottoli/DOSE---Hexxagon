...
extern EIF_TYPED_VALUE F566_10029(EIF_REFERENCE);
...
EIF_TYPED_VALUE F566_10029 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 565, Current, 0, 0, 12413);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(565, Current, 12413);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(3);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(565, 32, dtype))(Current)).it_i4);
	ui4_1 = ti4_1;
