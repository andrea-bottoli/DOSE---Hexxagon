...
static EIF_TYPE_INDEX gen_type0_85 [] = {0,1221,84,0xFFFF};
static EIF_TYPE_INDEX gen_type1_85 [] = {0,0,0xFFFF};
static EIF_TYPE_INDEX gen_type2_85 [] = {0,0,0xFFFF};
static EIF_TYPE_INDEX gen_type3_85 [] = {0,0,0xFFFF};


static struct desc_info desc_85[] = {
	{(BODY_INDEX) -1, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 787, NULL},
	{1, (BODY_INDEX)-1, 1221, gen_type0_85},
