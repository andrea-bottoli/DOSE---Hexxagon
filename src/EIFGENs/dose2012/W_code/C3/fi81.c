...
extern EIF_TYPED_VALUE F81_2871(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F81_2872(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
#ifndef INLINE_F81_2872
static int inline_F81_2872 (EIF_POINTER arg1, EIF_POINTER arg2)
{
...
EIF_TYPED_VALUE F81_2871 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 80, Current, 2, 2, 2731);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(80, Current, 2731);
	if (arg1) {
		RTCC(arg1, 80, l_feature_name, 1, 787);
	}
	if (arg2) {
		RTCC(arg2, 80, l_feature_name, 2, 787);
	}
	RTIV(Current, RTAL);
...
body:;
	...
	up2 = tp2;
	Result = EIF_TEST ((((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(80, 33, dtype))(Current, up1x, up2x))).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(8);
	RTDBGLE;
...
EIF_TYPED_VALUE F81_2872 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_p
	...
	RTEAA(l_feature_name, 80, Current, 0, 2, 2732);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(80, Current, 2732);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("a_path1_not_null", EX_PRE);
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(80, 30, dtype))(Current)).it_p);
...
body:;
	Result = EIF_TEST(inline_F81_2872 ((EIF_POINTER) arg1, (EIF_POINTER) arg2));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
