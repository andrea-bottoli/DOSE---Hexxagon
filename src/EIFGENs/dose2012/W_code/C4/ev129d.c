...
static EIF_TYPE_INDEX gen_type0_129 [] = {0,1221,128,0xFFFF};
static EIF_TYPE_INDEX gen_type1_129 [] = {0,0,0xFFFF};
static EIF_TYPE_INDEX gen_type2_129 [] = {0,0,0xFFFF};
static EIF_TYPE_INDEX gen_type3_129 [] = {0,0,0xFFFF};


static struct desc_info desc_129[] = {
	{(BODY_INDEX) -1, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 787, NULL},
	{1, (BODY_INDEX)-1, 1221, gen_type0_129},
