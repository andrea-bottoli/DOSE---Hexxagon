...
extern EIF_TYPED_VALUE F273_5611(EIF_REFERENCE);
extern EIF_TYPED_VALUE F273_5612(EIF_REFERENCE);
...
EIF_TYPED_VALUE F273_5611 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 272, Current, 0, 0, 5398);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(272, Current, 5398);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F273_5612 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 272, Current, 0, 0, 5399);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(272, Current, 5399);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800021A, 0,0); /* Result */
