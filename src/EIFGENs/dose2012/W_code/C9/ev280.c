...
extern EIF_TYPED_VALUE F280_5665(EIF_REFERENCE);
...
EIF_TYPED_VALUE F280_5665 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 279, Current, 0, 0, 5451);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(279, Current, 5451);
	RTIV(Current, RTAL);
	RTHOOK(1);
