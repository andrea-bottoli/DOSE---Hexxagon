...
extern EIF_TYPED_VALUE F282_5672(EIF_REFERENCE);
extern EIF_TYPED_VALUE F282_5673(EIF_REFERENCE);
...
EIF_TYPED_VALUE F282_5672 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 281, Current, 0, 0, 5457);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(281, Current, 5457);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F282_5673 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 281, Current, 0, 0, 5456);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(281, Current, 5456);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800021A, 0,0); /* Result */
