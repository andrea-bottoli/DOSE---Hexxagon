...
feature -- Initialization
	...
	do
		...
		extend_with_position_and_size (port_label,560,170,100,25)
		extend_with_position_and_size (port_field,570, 200, 240, 25)
		...
		create menu_title.make_with_text ("Insert port to start the broadcast.")
		...
		extend_with_position_and_size (image_container,0, 100, 477, 335)
			...
			-- Create the buttons
		create connect_btn.make("Create Game")
		...
		extend_with_position_and_size(connect_btn,760,300,125, 136)
		extend_with_position_and_size(goback_btn,550,300,125, 136)
		...
		create welcome_msg.make_with_text ("Create a game")
