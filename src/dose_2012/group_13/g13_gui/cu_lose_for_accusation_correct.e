...
feature
	...
	make (a_player: CU_ENUM_SUSPECTS;a_suspect_card: CU_SUSPECT_CARD; a_weapon_card: CU_WEAPON_CARD; a_room_card: CU_ROOM_CARD)
		...
		do
			set_message("The proposed accusation is true, %N you lose this match")
			...
			con_accusation_correct.extend_with_position_and_size (accept_button, 70, 100, 80, 40)
			con_accusation_correct.extend_with_position_and_size (label_window, 30, 20 , 200, 80)
