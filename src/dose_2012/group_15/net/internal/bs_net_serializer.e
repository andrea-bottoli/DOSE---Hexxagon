note
	description: "Summary description for {BS_NET_SERIALIZER}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
class
	...
	-- Thanks to Patrick Ruckstuhl for this code snippet, which is taken from here:
	-- http://community.eiffel.com/room/article/serialization_to_string
