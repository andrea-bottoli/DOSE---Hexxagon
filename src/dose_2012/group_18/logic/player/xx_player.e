...
feature {ANY}
	...
	make_player(id: INTEGER; colour: STRING)	--Constructor of object Player
		--substitute the value 5 with Max_value
	require (id>=0 and id<=5) and (colour_piece.is_equal("Rubies") = True or colour_piece.is_equal("Pearls") = True)
	do
