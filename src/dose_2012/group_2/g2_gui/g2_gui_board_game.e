...
feature {NONE} -- Implementation
	...
	set_position_object_board
		do
			...
			f_fixed_board.set_item_x_position (l_title, 0080)
			f_fixed_board.set_item_y_position (l_title, 0020)
			f_fixed_board.set_item_width (l_title, 0272)
			f_fixed_board.set_item_height (l_title, 0040)
				--set position button disconnect
			f_fixed_board.set_item_x_position (b_disconnect, 0160)
			f_fixed_board.set_item_y_position (b_disconnect, 0640)
			f_fixed_board.set_item_width (b_disconnect, 0125)
			f_fixed_board.set_item_height (b_disconnect, 0044)
		end

	set_position_object_player_1
		do
				--set position label l_turn
			f_fixed_player1.set_item_x_position (l_turn1, 0040)
			f_fixed_player1.set_item_y_position (l_turn1, 0020)
			f_fixed_player1.set_item_width (l_turn1, 0080)
			f_fixed_player1.set_item_height (l_turn1, 0040)
				--set position button b_player1_card1
			f_fixed_player1.set_item_x_position (b_player1_card1, 0020)
			f_fixed_player1.set_item_y_position (b_player1_card1, 0080)
			f_fixed_player1.set_item_width (b_player1_card1, 0137)
			f_fixed_player1.set_item_height (b_player1_card1, 0166)
				--set position button b_player1_card2
			f_fixed_player1.set_item_x_position (b_player1_card2, 0020)
			f_fixed_player1.set_item_y_position (b_player1_card2, 0160)
			f_fixed_player1.set_item_width (b_player1_card2, 0137)
			f_fixed_player1.set_item_height (b_player1_card2, 0166)
				--set position button b_player1_card3
			f_fixed_player1.set_item_x_position (b_player1_card3, 0020)
			f_fixed_player1.set_item_y_position (b_player1_card3, 0240)
			f_fixed_player1.set_item_width (b_player1_card3, 0137)
			f_fixed_player1.set_item_height (b_player1_card3, 0166)
				--set position button b_player1_card4
			f_fixed_player1.set_item_x_position (b_player1_card4, 0020)
			f_fixed_player1.set_item_y_position (b_player1_card4, 0320)
			f_fixed_player1.set_item_width (b_player1_card4, 0137)
			f_fixed_player1.set_item_height (b_player1_card4, 0166)
				--set position button b_player1_card5
			f_fixed_player1.set_item_x_position (b_player1_card5, 0020)
			f_fixed_player1.set_item_y_position (b_player1_card5, 0400)
			f_fixed_player1.set_item_width (b_player1_card5, 0137)
			f_fixed_player1.set_item_height (b_player1_card5, 0166)
				--set position label l_score_player_1
			f_fixed_player1.set_item_x_position (l_score_player_1, 0020)
			f_fixed_player1.set_item_y_position (l_score_player_1, 0620)
			f_fixed_player1.set_item_width (l_score_player_1, 0140)
			f_fixed_player1.set_item_height (l_score_player_1, 0120)
		end

	set_position_object_player_2
		do
				--set position label l_turn
			f_fixed_player2.set_item_x_position (l_turn2, 0020)
			f_fixed_player2.set_item_y_position (l_turn2, 0020)
			f_fixed_player2.set_item_width (l_turn2, 0080)
			f_fixed_player2.set_item_height (l_turn2, 0040)
				--set position button b_player2_card1
			f_fixed_player2.set_item_x_position (b_player2_card1, 0000)
			f_fixed_player2.set_item_y_position (b_player2_card1, 0080)
			f_fixed_player2.set_item_width (b_player2_card1, 0137)
			f_fixed_player2.set_item_height (b_player2_card1, 0166)
				--set position button b_player2_card2
			f_fixed_player2.set_item_x_position (b_player2_card2, 0000)
			f_fixed_player2.set_item_y_position (b_player2_card2, 0160)
			f_fixed_player2.set_item_width (b_player2_card2, 0136)
			f_fixed_player2.set_item_height (b_player2_card2, 0166)
				--set position button b_player2_card3
			f_fixed_player2.set_item_x_position (b_player2_card3, 0000)
			f_fixed_player2.set_item_y_position (b_player2_card3, 0240)
			f_fixed_player2.set_item_width (b_player2_card3, 0137)
			f_fixed_player2.set_item_height (b_player2_card3, 0166)
				--set position button b_player2_card4
			f_fixed_player2.set_item_x_position (b_player2_card4, 0000)
			f_fixed_player2.set_item_y_position (b_player2_card4, 0320)
			f_fixed_player2.set_item_width (b_player2_card4, 0137)
			f_fixed_player2.set_item_height (b_player2_card4, 0166)
				--set position button b_player2_card5
			f_fixed_player2.set_item_x_position (b_player2_card5, 0000)
			f_fixed_player2.set_item_y_position (b_player2_card5, 0400)
			f_fixed_player2.set_item_width (b_player2_card5, 0137)
			f_fixed_player2.set_item_height (b_player2_card5, 0166)
				--set position label l_score_player_2
			f_fixed_player2.set_item_x_position (l_score_player_2, 0000)
			f_fixed_player2.set_item_y_position (l_score_player_2, 0620)
			f_fixed_player2.set_item_width (l_score_player_2, 0140)
			f_fixed_player2.set_item_height (l_score_player_2, 0120)
		end
		...
		do
			if (attached {G2_GUI_CELL} table_board_game.item_at_position (col_1, row_1) as button) then
				if (not button.is_occupied) then
					...
					w_main_menu.set_move (card_captured, row_1, col_1)
