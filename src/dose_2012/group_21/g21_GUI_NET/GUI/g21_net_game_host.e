note
	description: "Summary description for {G21_NET_GAME_HOST}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
feature {NONE}
	...
	do
	--	listener.message("Host; "+port_text.text)
	port_text.text.prune_all(' ')
	listener.newGame(false,0, port_text.text.to_integer)
	end

feature {NONE}
	net_horizontal_box: EV_VERTICAL_BOX
	port_img: EV_PIXMAP
	port_text: EV_TEXT_FIELD
	ok: EV_BUTTON
