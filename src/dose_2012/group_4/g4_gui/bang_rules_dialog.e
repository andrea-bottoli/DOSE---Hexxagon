note
	description	: "The Bang! game rules dialog"
...
feature {NONE} -- Initialization
	...
	initialize
		...
		do
			...
			create pixmap
			pixmap.set_with_named_file (file_system.pathname_to_string (bang_img_rules))
			pixmap.set_minimum_size (140, 140)
			...
			create ok_button.make_with_text ("Return to Bang! main window")
			ok_button.set_minimum_size (175, 32)
			...
			text_area.set_with_named_file (create {FILE_NAME}.make_from_string(file_system.pathname_to_string (bang_rtf_rules)))
...
feature {NONE} -- Implementation / Constants
	...
	Default_title: STRING = "Bang! Credits"
			-- Default title for the dialog window.

	Default_message: STRING =
		"The Bang! game was developed by the PUCRS6 and Crete13 teams in the Dose 2012 program. We are:%N%
		%- Diogo Strube de Lima%N%
		%- Vinicius Cassol%N%
		%- Rossana Baptista Queiroz%N%
		%- TODO: Add Crete12 folks here!!!"
