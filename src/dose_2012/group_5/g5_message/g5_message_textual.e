note
	description: "[
					Summary description of the class G5_MESSAGE_TEXTUAL, which manages the actions 
					related to invalid action(generated by the player) or changes of the game state
					(phase and turn) and also for special Kingdom Cards effects.
					]"
	author: "Luca Falsina"
	date: "14.11.2012"
	revision: "1.3"
	...
	make(a_source: STRING; some_targets: ARRAY [STRING]; an_action: STRING; a_textual_message: STRING)
		...
		require
			...
			accepted_action_for_textual_message:
				...
				an_action.is_equal ("response") xor
				an_action.is_equal ("leave") xor
				an_action.is_equal ("has_left") xor
				an_action.is_equal ("terminate_game") xor
				an_action.is_equal ("rematch_choice:taken") xor
				an_action.is_equal ("rematch_choice:not_taken")
			...
			terminate_game_action_setting:
				an_action.is_equal ("terminate_game") implies
				(a_textual_message.is_equal("no_rematch_taken") xor a_textual_message.starts_with("critical_disconnection"))
