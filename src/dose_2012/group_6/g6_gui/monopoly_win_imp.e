...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			window.extend (l_ev_frame_1)
			l_ev_frame_1.extend (l_ev_pixmap_1)

			l_ev_pixmap_1.set_minimum_width (800)
			l_ev_pixmap_1.set_minimum_height (600)
			l_ev_pixmap_1.set_with_named_file ("C:\Users\Fauzi\Desktop\Monopoly_GUI\TABULEIRO.png")
			window.set_minimum_width (800)
			window.set_minimum_height (600)
			window.set_maximum_width (1024)
			window.set_maximum_height (768)
			window.set_title ("MONOPOLY")
			...
			window.close_request_actions.extend (agent window.destroy_and_exit_if_last)
