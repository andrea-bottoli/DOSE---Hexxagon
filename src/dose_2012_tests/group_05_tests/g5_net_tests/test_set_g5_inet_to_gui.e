...
-- ALL THESE TESTS can't be correctly executed since they require the use of features on a complete GUI
-- component, which needs a reference to a G5_LAUNCHER and MAIN_VIEW objects which can not be given
-- except of at Runtime level. So these tests will be commented out.
--																			Luca Falsina
