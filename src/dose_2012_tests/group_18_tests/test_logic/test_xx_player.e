	...
	test_set_port_number
		...
		do
			...
			loop
				...
				l_p_port_number:=l_p_port_number+1
			end
		end

	--Tests the method get_colour_piece
	test_get_colour_piece
		note
	...
	test_set_total_pieces
		...
		do
			...
			loop
				...
				l_p_total_piece:=l_p_total_piece+1
			end
		end

	--Tests the method get_get_total_pieces
	test_get_total_pieces
		note
