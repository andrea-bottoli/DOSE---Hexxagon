...
feature {NONE}	-- Initialization
	...
	initialize
		...
		do
			...
			-- GAME FRAME
			create game_frame
			bang_background_area.extend_with_position_and_size (game_frame, 190, 20, 800 - 195 - 20, 600 - 20 - 20)
			game_frame.hide
...
feature {NONE} -- Implementation
	...
	request_new_game(a_a, a_b, a_c: INTEGER_32; a_d, a_e, a_f: REAL_64; a_g, a_h: INTEGER_32)
		do
		--	create game_frame
			--game_frame.extend_with_position_and_size(game_frame, 500, 500, 500, 500)
			game_frame.show
		end
