...
feature -- Test routines
	...
	test_add_action
		...
		do
			...
			create a_player.make ("player_name", table)
	...
	test_get_new_hand
		...
		local
			a_player: G5_PLAYER
			-- MODIFICATA RIGA SOTTO da LIST a LINKED_LIST
			old_hand: LINKED_LIST[G5_CARD]
			table: G5_TABLE
		do
			-- MODIFICATA RIGA SOTTO
			create a_player.make ("player_name", table)
	...
	test_draw_card_deck
		...
		local
			a_player: G5_PLAYER
			-- MODIFICATA RIGA SOTTO da ARRAY a LINKED_LIST
			cards_drawn: LINKED_LIST[G5_CARD]
			table: G5_TABLE
		do
			-- MODIFICATA RIGA SOTTO
			create a_player.make ("player_name", table)
